...
for b = 1 : Nblocks
    ...
    AGC_values = load_AGC_block( file_pre, first_rg_line, Nrg_lines_blk, b , UseMATfiles ); 
                                         
                                      
    %  Load a block of raw SAR data
    data = load_DATA_block( file_pre, output_path, Nrg_lines_blk,Nrg_cells, AGC_values, b, UseMATfiles );
